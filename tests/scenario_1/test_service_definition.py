...
class TestServiceDefinition:
    ...
    def test_create_GOS_service_subservice(self, al: Alumni, driver: Chrome):
        ...
        dr1 = al.find("'المجموعة' dropdown list")
        dr1.click()
        dr_area = al.area("'المجموعة' dropdown list")
        dr_area.do("click on 'مجموعة للأتمتة' text")
        ...
        servicesArea.do("click on the second'الخدمات' button ")



        servicesArea.do("search for 'خدمة للأتمتة' in the search box")
        al.check("'خدمة للأتمتة' is displayed in the search results under 'الاسم بالعربية' column")


        # Create a new subservice
        al.do("Click on the 'الخدمات الفرعية' button next to 'الخدمات' button")
        al.do("hover over 'إنشاء خدمة فرعية جديدة' button")

        al.do("click on 'إنشاء خدمة فرعية جديدة' button")
        ...
        dr2.click()
        dr_area = al.area("'الخدمة' dropdown list")
        dr_area.do("click on 'خدمة للأتمتة' text")

        al.do("hover on 'حفظ' button")
        al.do("Click on the 'حفظ' button")

        al.do("search for 'خدمة فرعية للأتمتة' in the search box")
        al.check("'خدمة فرعية للأتمتة' is displayed in the search results under 'الاسم بالعربية' column")
    ...
    @pytest.mark.order(3)
    def test_delete_GOS_service_subservice(self, al: Alumni, driver: Chrome):
        ...
        al.do("search for 'مجموعة للأتمتة' in the search box")
        time.sleep(1)
        al.check("'مجموعة للأتمتة' is displayed in the search results under 'الاسم بالعربية' column")
        gos_area = al.area("'مجموعة للأتمتة' row")
        gos_area.do("click on the button in the first cell that contains image")
        ...
        al.do("search for 'مجموعة للأتمتة' in the search box")
        al.check("'مجموعة للأتمتة' is not displayed in the search results under 'الاسم بالعربية' column")
